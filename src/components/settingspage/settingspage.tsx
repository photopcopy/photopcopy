				...
				<div key="contentContainer" style={{ position: "relative", width: "100%", height: "100%" }}>
							...
							<div style={{ display: "flex" }}>
								...
								<button
									style={{
										...
										border: "none",
										cursor: "pointer",
										color: Settings.currentState.textColorInverted,
					...
					<Page self={PageTypes.Appearance} current={page}>
						<Section title={strings.sections.theme.title}>
							<RadioSelection
								...
								updated={(value) => {
									switch (value) {
										case 0:
											Settings.set("theme", "lightMode");
											break;
										case 1:
											Settings.set("theme", "darkMode");
											break;
									}
								}}
							/>
						...
						<Section title={strings.sections.embeds.title}>
							<span style={{ fontSize: 12, color: Settings.currentState.textColorSecondary }}>
								...
								updated={(value) => {
									switch (value) {
										case 0:
											...
											break;
										case 1:
											Settings.set("language", "retarded");
											break;
									}
								}}
							/>
