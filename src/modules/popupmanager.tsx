...
function PopupManager(){
    ...
    function AddPopup(key: string, isOpen: boolean, callback: (onRequestClose: ()=>void, isOpen: boolean)=>React.ReactElement){
        const obj: PopupObj = {open: isOpen, key: key, renderFunction: (open)=>{
            return callback(()=>{
                obj.open = false;
